...
import { BarChart3, BookMarked, BookOpen, BrainCircuit, Clock, Database, Download, Flag, Library, ListMusic, RotateCcw, Settings, ShieldCheck, Target } from "lucide-react";
...
export const routeManifest: RouteManifestEntry[] = [
  {
    path: "/",
    label: "LSAT Library",
    commandLabel: "Go to LSAT Library",
    group: "Insight",
    icon: BookOpen,
  ...
  {
    path: "/dashboard",
    label: "LSAT Curriculum",
    commandLabel: "Go to LSAT Curriculum",
    group: "Insight",
    icon: BarChart3,
    keywords: ["learn", "curriculum", "dashboard", "overview", "readiness"],
    hideInTest: true,
  },
  {
    path: "/practice",
    label: "Practice",
    commandLabel: "Go to Practice",
    group: "Practice",
    icon: Clock,
    keywords: ["practice", "today"],
  },
  {
    path: "/preptests",
    label: "PrepTests",
    commandLabel: "Go to PrepTests",
    group: "Practice",
    icon: Library,
    keywords: ["exams", "tests"],
  },
  {
    path: "/drills",
    label: "Drills",
    commandLabel: "Go to Drills",
    group: "Practice",
    icon: Target,
    keywords: ["adaptive", "questions"],
  },
  {
    path: "/playlists",
    label: "Smart sets",
    commandLabel: "Go to Smart sets",
    group: "Practice",
    icon: ListMusic,
    keywords: ["playlists", "custom sets", "problem sets"],
  },
  {
    path: "/tutor",
    label: "Tutor",
    commandLabel: "Go to Tutor",
    group: "Insight",
    icon: BrainCircuit,
    keywords: ["socratic", "blind review", "why loop"],
    hideInTest: true,
  },
  {
    path: "/notebook",
    ...
    group: "Insight",
    icon: BookOpen,
    keywords: ["library", "notebook", "curriculum", "wiki", "notes", "sources", "study sheet"],
    hideInTest: true,
    capability: "notebook_os",
    canonicalPath: "/",
  },
  {
    path: "/rc-lab",
    label: "RC Lab",
    commandLabel: "Go to RC Lab",
    group: "Insight",
    icon: BookMarked,
    keywords: ["reading comprehension", "passage maps"],
    hideInTest: true,
  },
  {
    path: "/review",
    label: "Review",
    commandLabel: "Go to Review",
    group: "Insight",
    icon: Flag,
    keywords: ["blind review", "missed"],
    hideInTest: true,
  },
  {
    path: "/review/history",
    label: "Session history",
    commandLabel: "Go to Session history",
    group: "Insight",
    icon: Clock,
    keywords: ["past", "compare", "history"],
    hideInTest: true,
  },
  {
    path: "/srs",
    label: "SRS",
    commandLabel: "Go to SRS",
    group: "Insight",
    icon: RotateCcw,
    keywords: ["spaced repetition", "flashcards"],
    hideInTest: true,
  },
  {
    path: "/analytics",
  ...
  },
  {
    path: "/bank",
    label: "Bank",
    commandLabel: "Go to Bank",
    group: "Setup",
    icon: Database,
    keywords: ["dataset", "questions", "content"],
    hideInTest: true,
  },
  {
    path: "/content-ops",
    label: "Content Ops",
    commandLabel: "Go to Content Ops",
    group: "Setup",
    icon: ShieldCheck,
    keywords: ["trust", "validators", "scheduler"],
    hideInTest: true,
  },
  {
    path: "/quarantine",
    label: "Quarantine",
    commandLabel: "Go to Quarantine",
    group: "Setup",
    icon: ShieldCheck,
  ...
  },
  {
    path: "/import",
    label: "Import",
    commandLabel: "Go to Import",
    group: "Setup",
    icon: Download,
    keywords: ["pdf", "source", "ingest"],
    hideInTest: true,
  },
  {
    path: "/settings",
